  ...
  factory MediaStream.fromJson(Map<String, dynamic> json) {
    return MediaStream(
      ...
      isDefault: (json['IsDefault'] as bool?) ??
          ...
          false,
      isForced:
          (json['IsForced'] as bool?) ?? (json['is_forced'] as bool?) ?? false,
      isExternal: (json['IsExternal'] as bool?) ??
          (json['is_external'] as bool?) ??
          false,
      deliveryUrl:
          (json['DeliveryUrl'] as String?) ?? (json['delivery_url'] as String?),
