            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  if (onClose != null)
                    IconButton(
                      icon: Icon(Icons.close, color: scheme.onSurfaceVariant.withValues(alpha: 0.7)),
                      onPressed: onClose,
                    ),
                ],
              ),
        ...
        child: Row(
          children: [
            ...
            Container(
              ...
              height: 36,
              decoration: BoxDecoration(
                color: isSelected ? scheme.primary.withValues(alpha: 0.12) : scheme.onSurface.withValues(alpha: 0.1),
