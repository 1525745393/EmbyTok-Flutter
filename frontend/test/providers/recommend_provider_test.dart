...
class _MockMediaRepository extends Mock implements MediaRepository {
  ...
  // ---- MovieRecommendationGroups（原生电影推荐分组横幅，默认空）----
  @override
  Future<List<NativeRecGroup>> getMovieRecommendationGroups({
    ...
    String? token,
      ...
      super.noSuchMethod(
        Invocation.method(#getMovieRecommendationGroups, [], {
          #userId: userId,
          #libraryId: libraryId,
          #serverUrl: serverUrl,
          #token: token,
        }),
        returnValue: Future.value(<NativeRecGroup>[]),
  ...
  Future<PaginatedResponse<MediaItem>> getItemsByPersonIds({
    ...
    String? userId,
      ...
      super.noSuchMethod(
        Invocation.method(#getItemsByPersonIds, [], {
          #personIds: personIds,
          #limit: limit,
          #offset: offset,
          #serverUrl: serverUrl,
